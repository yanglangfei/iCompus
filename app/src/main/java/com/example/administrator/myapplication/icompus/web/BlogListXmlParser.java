...
public class BlogListXmlParser extends DefaultHandler {
	...
	final String ENTRY_USER_NAME_TAG="blogapp";
	final String ENTRY_AUTHOR_URL_TAG = "uri";
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (isStartParse) {// ����Ŀ��
			...
			if (localName.equalsIgnoreCase(ENTRY_TITLE_TAG)) {// ����
			...
			} else if (localName.equalsIgnoreCase(ENTRY_USER_NAME_TAG)) {// �����û���
				...
				Log.i("BlogXml", chars);
			} else if (localName.equalsIgnoreCase(ENTRY_AUTHOR_URL_TAG)) {// �û���ҳ
